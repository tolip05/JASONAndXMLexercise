...
public class Terminal implements CommandLineRunner {
    ...
    @Autowired
    public Terminal(AnimalAidController animalAidController, AnimalController animalController, VetController vetController, ProcedureController procedureController, FileIO fileIO, ConsoleIO consoleIO) {
    ...
    public void run(String... strings) throws Exception {
       this.consoleIO.write(this.animalAidController
        ...
        this.consoleIO.write(this.animalController
                .importDataFromJSON(this.fileIO.read(Config.ANIMALS_IMPORT_JSON)));


        this.consoleIO.write(this.vetController
                .importDataFromXML(this.fileIO.read(Config.VETS_IMPORT_XML)));

        this.consoleIO.write(this.procedureController
                .importDataFromXML(this.fileIO.read(Config.PROCEDURES_IMPORT_XML)));

      this.fileIO.write(this.animalController.exportAnimalsByOwnerPhoneNumber("0897556446"),"exportAnimalByOwnerPhoneNumber.json");
